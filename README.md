...
Cómo funciona
Detecta automáticamente el tipo de IOC que se le pasa (hash / IP / dominio / URL).
Consulta VirusTotal para obtener el conteo de motores que lo marcan como malicioso.
Consulta AlienVault OTX para ver cuántos reportes de la comunidad existen sobre ese indicador.
Muestra ambos veredictos y guarda el resultado en un historial local.
Requisitos
Python 3.10+
Librería requests
API key gratuita de VirusTotal
API key gratuita de AlienVault OTX
Instalación
bash
